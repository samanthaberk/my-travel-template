const data = {
    ...
    questions: [
      ...
      {
        number: 2,
        question: "HAVE YOU TRAVELED HERE BEFORE?",
      ...
      {
        number: 4,
        question: "WHAT DO YOU WANT TO SEE WHEN YOU TRAVEL?",
        answerChoices: ["Iconic Highlights", "Hidden Gems", "A Bit of Both"],
        bgImage: "./Images/mountainTemple.JPG"
      },
      {
        number: 5,
        question: "HOW WOULD YOU LIKE TO TRAVEL WITHIN THE COUNTRY? (SELECT ALL THAT APPLY)",
        answerChoices: ["Train", "Bus", "Internal Flights", "Private Driver"],
        bgImage: "./Images/trainStation.JPG"
      },
      {
        number: 6,
        question: "HOW WOULD YOU LIKE TO GET AROUND WITHIN A CITY? (SELECT ALL THAT APPLY)",
        answerChoices: ["Walk", "Public transport", "Bike", "Taxi"],
        bgImage: "./Images/shanghai.JPG"
      },
      {
        number: 7,
        question: "WHICH OF THE FOLLOWING BEST DESCRIBES YOUR TRAVEL PARTY?",
      ...
      {
        number: 9,
        question: "RATE YOUR INTEREST IN THE FOLLOWING...",
